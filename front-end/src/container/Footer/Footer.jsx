...
const handleSubmit = () => {
  ...
  return (
    <>
      <h2 className='head-tex'>Take a coffe and chat with me</h2>
      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          <img src={images.email} alt="email" />
          <a href="mailto:koinyannelson0.com" className='p-text'>Koinyannelson0@gmail.com</a>
        </div>
        
        <div className='app__footer-card'>
          <img src={images.mobile} alt="mobile" />
          <a href="tel: +234 9157734351" className='p-text'>+234 9157734351</a>
        </div>
      </div>
